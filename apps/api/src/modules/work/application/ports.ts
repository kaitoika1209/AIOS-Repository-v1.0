...
export interface WorkCommandLedger { result(commandId:string):Promise<unknown|undefined>; record(commandId:string,organizationId:string,commandType:string,result:unknown):Promise<void>; }
